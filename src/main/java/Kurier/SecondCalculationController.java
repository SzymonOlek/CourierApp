...
public class SecondCalculationController {
	...
	protected void initialize() {
		...
		counterinteger= Counter.numberOfCalculatingWindowsSend;
		counter.setText("Okno numer : " + String.valueOf(Counter.numberOfCalculatingWindowsSend));
		Counter.numberOfCalculatingWindowsSend += 1;

		Server server = new Server();

		objectWraper = server.getOrdersToCalculateSend(counterinteger);
